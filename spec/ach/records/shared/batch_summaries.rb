    ...
    Proc.new do
      describe '#service_class_code' do
        ...
        it 'must be a 200, 220, 225 or 280' do
          expect { @record.service_class_code = '201' }.to raise_error(RuntimeError)
          expect { @record.service_class_code = 201 }.to raise_error(RuntimeError)
          expect { @record.service_class_code = '2020' }.to raise_error(RuntimeError)
          expect { @record.service_class_code = '20' }.to raise_error(RuntimeError)
        end
